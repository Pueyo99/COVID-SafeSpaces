...
public class HelpFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        img1= vista.findViewById(R.id.home_img);
        img2= vista.findViewById(R.id.capture_img);
        img3= vista.findViewById(R.id.profile_img);
        text3.setMovementMethod(new ScrollingMovementMethod());
        img1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                text2.setText("Home screen");
                text3.setText("In this screen you will be capable to see, edit or delete your previous measurements. " +
        ...
        img2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                text2.setText("Capture screen");
                text3.setText("As you can see in this screen you will see some instructions of what you have to do in this part. In this part " +
        ...
        img3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                text2.setText("Profile screen");
                text3.setText("In this screen you will  be able to see you personal data (username and email) and to change your password if you want. If you deccide to" +
